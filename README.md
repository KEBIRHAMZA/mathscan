...
```
cd existing_repo
git remote add origin https://gitlab.com/aazzioui/mathscanlandingpage.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/aazzioui/mathscanlandingpage/-/settings/integrations)
