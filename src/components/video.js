          ...
          <div className="w-full px-4 lg:w-10/12">
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              <div className="absolute left-0 top-0 h-full w-full">
                <img
                  src="https://scontent.frba3-1.fna.fbcdn.net/v/t39.30808-6/340639360_1201227167200223_4834695551163558263_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=783fdb&_nc_ohc=raylLXy4lacAX9s_fL5&_nc_ht=scontent.frba3-1.fna&oh=00_AfCh4XTULX80zzZcjK43sGvK9yHKTcAVDA1ETXcJk6dncA&oe=65E97012"
                  alt="bg"
        ...
        <div className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
          <div className="mx-auto w-full max-w-[550px] bg-white">
            ...
            <iframe
                ...
                src="https://www.youtube.com/embed/G90FGCnsYDo"
                title="YouTube Video"
                allowFullScreen
            />
            </>
