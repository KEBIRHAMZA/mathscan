...
export default function Cardsparent() {
  ...
  return (
    <div className='cards-parents-container' style={{ marginTop:"150px" }}>
        <div>
      <h1 className="text-center text-4xl mb-8">{intl.formatMessage({ id: 'titrecardsone' })} <span className="font-bold">{intl.formatMessage({ id: 'spanCards' })}</span> <br/>
