            ...
            <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
                <div className="lg:flex lg:items-center">
                    <div className="lg:w-1/2">
                        ...
                        <p className="max-w-xl mb-6 text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"> <span style={{ color: '#f1bf5b', fontWeight: "bold" }}>Primaire</span> - <span style={{ color: '#f4876a', fontWeight: "bold" }}>Collège </span> - <span style={{ color: '#b46f8d', fontWeight: "bold" }}>lycée</span></p>
